	...
	<footer id="footer" class="container footer hide">
		{footerHTML}
		<div class="copyright">
			Powered by <a target="_blank" href="https://www.nodebb.com">Awesome NodeBB Forums</a> | Found a security bug? <a target="_top" href="mailto:security@lowendgeeks.com?Subject=Vulnerability%20report">Report it</a>
		</div>
	</footer>
